    ...
    <div className="px-4 py-10">
      <div className="mb-10">
        ...
        <div className="mt-10">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-orange-500 text-white font-bold py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 hover:bg-orange-600">
              Talk to seller
            </button>
      ...
      <div>
        ...
        <div className="mt-5 grid grid-cols-2 gap-x-4 gap-y-8">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              <div className="h-56 w-full mb-3 bg-slate-300" />
